...
leftover_pennies = leftover_pennies % 10

# change_amount = int(input(': '))
print(f"and, {leftover_pennies // 5} nickels leftover.") #{change_amount % 5} pennies leftover.")
leftover_pennies = leftover_pennies % 5

print(f"and, {leftover_pennies // 1} pennies leftover.")
